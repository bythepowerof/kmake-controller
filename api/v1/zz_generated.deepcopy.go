...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *KmakeRuns) DeepCopyInto(out *KmakeRuns) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new KmakeRuns.
func (in *KmakeRuns) DeepCopy() *KmakeRuns {
	if in == nil {
		return nil
	}
	out := new(KmakeRuns)
