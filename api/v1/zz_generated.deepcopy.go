...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *KmakeResources) DeepCopyInto(out *KmakeResources) {
	*out = *in
	if in.Pvc != nil {
	...
	if in.Kmake != nil {
		in, out := &in.Kmake, &out.Kmake
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new KmakeResources.
func (in *KmakeResources) DeepCopy() *KmakeResources {
	if in == nil {
		return nil
	}
	out := new(KmakeResources)
	in.DeepCopyInto(out)
	return out
}
